  ...
  return (
    <div className="min-h-screen bg-black text-white font-primary">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'glass-nav shadow-glow' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex flex-wrap space-x-8 space-y-2">
      ...
      <section id="skills" className="py-20 bg-black">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-2 font-accent glow-text">
            Skills & Expertise
          </h2>
        <p className="text-xl text-center mb-8 font-accent glow-text">
